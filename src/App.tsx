            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <div className="space-y-4">
                <div className="bg-white/20 rounded-lg p-4">
                  ...
                  <p className="text-blue-100 text-sm">Join us for Sukkot celebration with our community. A special evening of joy, celebration, and traditional Chag Celebration in our Suka in the backyard.</p>
                </div>
